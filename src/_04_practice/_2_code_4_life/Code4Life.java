...
public class Code4Life {
	...
	String codingtime = JOptionPane.showInputDialog("how many hours have you spent coding this week?");
	int codingtimeint = Integer.parseInt(codingtime);
	...
	if (codingtimeint >=3&& codingtimeint <=5) {
